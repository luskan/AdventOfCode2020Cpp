...
Task19::Task19(bool example, bool s2) {
  ...
  std::ifstream ifs(example ? (solve_2 ? "../data/data19_example_2.txt" : "../data/data19_example.txt") : "../data/data19_task.txt");
  std::string line;
...
void Task19::solve1() {
  ...
  verify_result(total, example_data ? 2 : 265);
...
void Task19::solve2() {
  ...
  verify_result(total, example_data ? 12 : 394);
