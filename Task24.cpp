...
Task24::Task24(bool example) {
  ...
  std::ifstream ifs(example ? "../data/data24_example.txt" : "../data/data24_task.txt");
  std::string line;
...
void Task24::solve1() {
  ...
  verify_result(count, example_data ? 10 : 473);
...
void Task24::solve2() {
  ...
  verify_result(count, example_data ? 2208 : 4070);
