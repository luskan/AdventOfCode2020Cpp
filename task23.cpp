...
uint64_t Task23::solve(bool task_2) {
  ...
  std::string data = example_data ? "389125467" : "215694783"; // m
...
void Task23::solve1() {
  ...
  verify_result(result, example_data ? 67384529ull : 46978532ull);
  std::cout << " part1: result = " << result << std::endl;
}

void Task23::solve2() {
  auto result = solve(true);
  verify_result(result, example_data ? 149245887792ull : 163035127721ull);
