...
void Task18::load(bool solve2) {
  std::fstream
      ifs(example_data ? (solve2 ? "../data/data18_example_2.txt" : "../data/data18_example.txt") : "../data/data18_task.txt");
  std::string line;
...
void Task18::solve1() {
  ...
  verify_result(total, example_data ? 26335ull : 53660285675207ull);
...
void Task18::solve2() {
  ...
  verify_result(total, example_data ? 693942ull : 141993988282687);
