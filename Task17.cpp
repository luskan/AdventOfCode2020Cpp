...
Task17::Task17(bool example) {
  ...
  std::ifstream ifs(example ? "../data/data17_example.txt" : "../data/data17_task.txt");
  std::string line;
  int y = 0;
  minx = 0;
  miny = 0;
...
void Task17::solve1() {
  ...
  verify_result(total_active, example_data ? 112 : 218);
...
void Task17::solve2() {
  ...
  verify_result(total_active, example_data ? 848 : 1908);
