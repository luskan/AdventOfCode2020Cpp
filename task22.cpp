...
Task22::Task22(bool example) {
  ...
  std::ifstream ifs(example ? "../data/data22_example.txt" : "../data/data22_task.txt");
  std::string line;
...
void Task22::solve1() {
  ...
  verify_result(result, example_data ? 306 : 32033);
...
void Task22::solve2() {
  ...
  verify_result(result, example_data ? 291 : 34901);
