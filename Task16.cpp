...
Task16::Task16(bool example) {
  ...
  std::ifstream ifs(example_data ? "../data/data16_example.txt" : "../data/data16_task.txt");
  std::string line;
...
void Task16::solve1() {
  ...
  verify_result(sum, example_data ? 71 : 23054);
...
void Task16::solve2() {
  ...
  if (example_data) {
    ...
    verify_result(solution, example_data ? 71 : 51240700105297ull);
