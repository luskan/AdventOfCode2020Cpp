...
Task21::Task21(bool example) {
  ...
  std::ifstream ifs(example ? "../data/data21_example.txt" : "../data/data21_task.txt");
  std::string line;
...
void Task21::solve1() {
  ...
  verify_result(final_count, example_data ? 5 : 2461);
...
void Task21::solve2() {
  ...
  verify_result(final_str, example_data ? "mxmxvkd,sqjhc,fvjkl"s : "ltbj,nrfmm,pvhcsn,jxbnb,chpdjkf,jtqt,zzkq,jqnhd"s);
