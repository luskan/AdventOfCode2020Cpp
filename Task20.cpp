...
Task20::Task20(bool example) {
  ...
  std::ifstream ifs(example ? "../data/data20_example.txt" : "../data/data20_task.txt");
  std::string line;
...
void Task20::solve1() {
  ...
  verify_result(total, example_data ? 20899048083289ull : 17032646100079ull);
...
void Task20::solve2() {
  ...
  verify_result(total_sea_roughness, example_data ? 273 : 2006);
